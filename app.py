...
# Carrega os dados e armazena na sessão
...
with col1:
    if 'resultado' in st.session_state:
        ...
        dados['jogador_1_enc'] = le_jogador.transform(dados['Jogador_1'])
        dados['jogador_2_enc'] = le_jogador.transform(dados['Jogador_2'])
...
with tab2:
    ...
    with st.form("editar_form"):
        ...
        if st.form_submit_button("Salvar Alterações"):
            ...
            if salvar_dados(df, caminho='src/data/historico_jogos.csv'):
    ...
    with st.form("novo_form"):
        ...
        if st.form_submit_button("Adicionar Registro"):
            ...
            if salvar_dados(df, caminho='src/data/historico_jogos.csv'):
                ...
                st.error("Erro ao adicionar novo registro")
